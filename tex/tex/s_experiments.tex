...
multiset-trie with respect to $|M|$ varies from~$0.03\%$ to~$0.95\%.$
...
submultiset or supermultiset, which is from $0.002\%$ to $0.15\%$ of the 
multiset-trie and from $\num{1.9e-5}\%$ to $\num{4.5e-5}\%$ of the complete 
multiset-trie.
...
from $\num{1.4e-13}\%$ to $\num{2.25e-12}\%.$ The density is much smaller than 
...
submultiset or supermultiset, which is from $0.15\%$ to $0.75\%$ of the entire 
multiset-trie and from $\num{1.1e-15}\%$ to $\num{3.4e-15}\%$ of the complete 
...
$\num{1.0e-4}\%$ to $1.0\%.$ The number of visited nodes was chosen to be 
...
around $d\approx \num{7.0e-3}\%.$ The maximum is less than $0.03\%$ and 
greater than $\num{1.4e-13}\%,$ which explains the behavior of multiset-trie in 
