...
%%% relats btwn math and emprcl anlyss
%%% concrete results? bounds, ...
%%% experiments confirm findings of math analysis?
...
In Section~\ref{c:experiments} we present an empirical study of the multiset-trie. Synthetic and real-world data sets are used in experiments that are designed to study the performance of multiset containment operations. The experiments highlight the methods for optimizing a multiset-trie. 
