...
\Author{Mikita Akulich $^{1,\ddagger}$, Iztok Savnik $^{1,2,\ddagger}$\orcidB{}, Matjaž Krnc $^{1,2,3,\ddagger}$\orcidC{}, and Riste Škrekovski $^{1,2,3,\ddagger}$\orcidD{}*}
...
\address{%
$^{1}$ \quad Faculty of mathematics, natural sciences and information technologies, \\University of Primorska, Slovenia;\\ %\{mikita.akulich,iztok.savnik,matjaz.krnc,riste.skrekovski\}@famnit.upr.si\\
$^{2}$ \quad Department of Mathematics, University of Ljubljana, Slovenia\\
$^{3}$ \quad Faculty of Information Studies, Novo Mesto, Slovenia}
